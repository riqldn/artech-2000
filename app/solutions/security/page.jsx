                        ...
                        <div className="flex flex-col gap-8 row-start-2 col-start-5 lg:col-start-7 col-end-13">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="accordion py-1 border-b border-t border-border">
                                    <button onClick={() => setActive(isActive === 1 ? false : 1)} className={isActive === 1 ? "accord-active font-geist text-header flex justify-between font-semibold text-md text-left p-2 accordion-btn w-full" : "font-geist flex justify-between font-semibold text-md text-left p-2 accordion-btn w-full"}>Cyber-Security</button>
                                ...
                                <div className="accordion py-1 border-b border-border">
                                    ...
                                    <div className={isActive === 6 ? "accordion-content max-h-max overflow-hidden px-2 py-4" : "accordion-content max-h-0 overflow-hidden px-2"} >
                                ...
                                <div className="accordion py-1 border-b border-border">
                                    ...
                                    <div className={isActive === 7 ? "accordion-content max-h-max overflow-hidden px-2 py-4" : "accordion-content max-h-0 overflow-hidden px-2"} >
                                ...
                                <div className="accordion py-1 border-b border-border">
                                    ...
                                    <div className={isActive === 8 ? "accordion-content max-h-max overflow-hidden px-2 py-4" : "accordion-content max-h-0 overflow-hidden px-2"} >
                                ...
                                <div className="accordion py-1 border-b border-border">
                                    ...
                                    <div className={isActive === 9 ? "accordion-content max-h-max overflow-hidden px-2 py-4" : "accordion-content max-h-0 overflow-hidden px-2"} >
                                ...
                                <div className="accordion py-1 border-b border-border">
                                    ...
                                    <div className={isActive === 10 ? "accordion-content max-h-max overflow-hidden px-2 py-4" : "accordion-content max-h-0 overflow-hidden px-2"} >
