    ...
    return (
        <>
            ...
            <section className='relative min-h-[90vh] md:min-h-screen w-full '>
                ...
                <Image alt='hero image of a hand interacting with a holographic menu' className='-z-10 object-cover object-[73%] md:object-top' priority={true} placeholder='blur' loading='eager' sizes='100vw'  src={Hero} fill quality={90} />
